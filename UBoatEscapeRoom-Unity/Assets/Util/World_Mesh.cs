...
// ******************************************************************************************************************
// 
// UBoatEscapeRoom-Unity.UBER.Player.World_Mesh.cs © SilentWolf6662 - All Rights Reserved
...
namespace UBER.Utils
{
    ...
    public class World_Mesh
    {
        ...
        public static World_Mesh Create(Vector3 position, float eulerZ, float meshWidth, float meshHeight, Material material, UVCoords uvCoords, int sortingOrderOffset = 0) => new World_Mesh(null, position, Vector3.one, eulerZ, meshWidth, meshHeight, material, uvCoords, sortingOrderOffset);

        public static World_Mesh Create(Vector3 lowerLeftCorner, float width, float height, Material material, UVCoords uvCoords, int sortingOrderOffset = 0) => Create(lowerLeftCorner, lowerLeftCorner + new Vector3(width, height), material, uvCoords, sortingOrderOffset);
        ...
        private static int GetSortingOrder(Vector3 position, int offset, int baseSortingOrder = sortingOrderDefault) => (int)(baseSortingOrder - position.y) + offset;
        ...
        public int GetSortingOrder() => gameObject.GetComponent<Renderer>().sortingOrder;
