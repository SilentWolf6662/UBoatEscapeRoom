...
// ******************************************************************************************************************
// 
// UBoatEscapeRoom-Unity.UBER.World_Bar.cs © SilentWolf6662 - All Rights Reserved
...
namespace UBER.Utils
{
    ...
    public class World_Bar
    {
        ...
        public static int GetSortingOrder(Vector3 position, int offset, int baseSortingOrder = 5000) => (int)(baseSortingOrder - position.y) + offset;
        ...
        public void SetRotation(float rotation) => transform.localEulerAngles = new Vector3(0, 0, rotation);
        public void SetSize(float sizeRatio) => bar.localScale = new Vector3(sizeRatio, 1, 1);
        public void SetColor(Color color) => bar.Find("BarIn").GetComponent<SpriteRenderer>().color = color;
