...
// ******************************************************************************************************************
// 
// UBoatEscapeRoom-Unity.UBER.Player.World_Sprite.cs © SilentWolf6662 - All Rights Reserved
...
namespace UBER.Utils
{
    ...
    public class World_Sprite
    {
        ...
        public static World_Sprite Create(Transform parent, Vector3 localPosition, Vector3 localScale, Sprite sprite, Color color, int sortingOrderOffset) => new World_Sprite(parent, localPosition, localScale, sprite, color, sortingOrderOffset);
        public static World_Sprite Create(Vector3 worldPosition, Sprite sprite) => new World_Sprite(null, worldPosition, new Vector3(1, 1, 1), sprite, Color.white, 0);
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, Sprite sprite, Color color, int sortingOrderOffset) => new World_Sprite(null, worldPosition, localScale, sprite, color, sortingOrderOffset);
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, Sprite sprite, Color color) => new World_Sprite(null, worldPosition, localScale, sprite, color, 0);
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, Color color) => new World_Sprite(null, worldPosition, localScale, Assets.i.s_White, color, 0);
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale) => new World_Sprite(null, worldPosition, localScale, Assets.i.s_White, Color.white, 0);
        public static World_Sprite Create(Vector3 worldPosition, Vector3 localScale, int sortingOrderOffset) => new World_Sprite(null, worldPosition, localScale, Assets.i.s_White, Color.white, sortingOrderOffset);
        ...
        public void SetSortingOrder(int sortingOrder) => gameObject.GetComponent<SpriteRenderer>().sortingOrder = sortingOrder;
