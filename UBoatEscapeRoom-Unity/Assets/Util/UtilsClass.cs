...
// ******************************************************************************************************************
// 
// UBoatEscapeRoom-Unity.UBER.Player.UtilsClass.cs © SilentWolf6662 - All Rights Reserved
...
namespace UBER.Utils
{
    ...
    public static class UtilsClass
    {
        ...
        public static int GetSortingOrder(Vector3 position, int offset, int baseSortingOrder = sortingOrderDefault) => (int)(baseSortingOrder - position.y) + offset;
        ...
        public static GameObject CreateWorldSprite(string name, Sprite sprite, Vector3 position, Vector3 localScale, int sortingOrder, Color color) => CreateWorldSprite(null, name, sprite, position, localScale, sortingOrder, color);
        ...
        public static Button_Sprite CreateWorldSpriteButton(string name, Sprite sprite, Vector3 localPosition, Vector3 localScale, int sortingOrder, Color color) => CreateWorldSpriteButton(null, name, sprite, localPosition, localScale, sortingOrder, color);
        ...
        public static void CreateWorldTextPopup(string text, Vector3 localPosition) => CreateWorldTextPopup(null, text, localPosition, 40, Color.white, localPosition + new Vector3(0, 20), 1f);
        ...
        public static Text DrawTextUI(string textString, Vector2 anchoredPosition, int fontSize, Font font) => DrawTextUI(textString, GetCanvasTransform(), anchoredPosition, fontSize, font);
        ...
        public static FunctionUpdater CreateMouseDraggingAction(Action<Vector3> onMouseDragging) => CreateMouseDraggingAction(0, onMouseDragging);
        ...
        public static FunctionUpdater CreateMouseClickFromToAction(Action<Vector3, Vector3> onMouseClickFromTo, Action<Vector3, Vector3> onWaitingForToPosition) => CreateMouseClickFromToAction(0, 1, onMouseClickFromTo, onWaitingForToPosition);
        ...
        public static FunctionUpdater CreateMouseClickFromToAction(int mouseButton, int cancelMouseButton, Action<Vector3, Vector3> onMouseClickFromTo, Action<Vector3, Vector3> onWaitingForToPosition)
        {
            ...
            return FunctionUpdater.Create(() =>
            {
                ...
                if (state == 1 && Input.GetMouseButtonDown(cancelMouseButton)) // Cancel
                    state = 0;
        ...
        public static FunctionUpdater CreateMouseClickAction(Action<Vector3> onMouseClick) => CreateMouseClickAction(0, onMouseClick);

        public static FunctionUpdater CreateMouseClickAction(int mouseButton, Action<Vector3> onMouseClick) => FunctionUpdater.Create(() =>
        {
            if (Input.GetMouseButtonDown(mouseButton))
        ...
        public static FunctionUpdater CreateKeyCodeAction(KeyCode keyCode, Action onKeyDown) => FunctionUpdater.Create(() =>
        {
        ...
        public static Vector3 GetWorldPositionFromUI() => GetWorldPositionFromUI(Input.mousePosition, Camera.main);

        public static Vector3 GetWorldPositionFromUI(Camera worldCamera) => GetWorldPositionFromUI(Input.mousePosition, worldCamera);
        ...
        public static Vector3 GetWorldPositionFromUI_Perspective() => GetWorldPositionFromUI_Perspective(Input.mousePosition, Camera.main);

        public static Vector3 GetWorldPositionFromUI_Perspective(Camera worldCamera) => GetWorldPositionFromUI_Perspective(Input.mousePosition, worldCamera);
