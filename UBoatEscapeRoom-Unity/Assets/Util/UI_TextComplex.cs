...
// ******************************************************************************************************************
// 
// UBoatEscapeRoom-Unity.UBER.Player.UI_TextComplex.cs © SilentWolf6662 - All Rights Reserved
    ...
    public class UI_TextComplex
    {
        ...
        public UI_TextComplex(Transform parent, Vector2 anchoredPosition, int fontSize, char iconChar, string text, Icon[] iconArr, Font font)
        {
            ...
            while (tmp.IndexOf(iconChar) != -1)
            {
                ...
                if (indexOfSpaceAfterIconNumber != -1) // Still has more space after iconNumber
        ...
        public void CenterOnPosition(Vector2 position) => rectTransform.anchoredPosition = position + new Vector2(-GetTotalWidth() / 2f, 0);
